...
const BestQuality = ({onPress}) => {

    const navigation = useNavigation();
    return (
        <View style={styles.container}>
            <View style={{ flex: 1 }}>
                <Image source={ImagePath.couple_shoping} resizeMode='contain' style={styles.cover_image} />
            </View>
            ...
            <View style={{ flex: 1, }}>
                <View style={styles.bottom_view}>
                    <Text style={styles.heading_text}>Best Quality, Affordable Price</Text>
